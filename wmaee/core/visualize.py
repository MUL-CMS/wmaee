...
def _get_orientation(view_plane):
    ...
    flattened list of len = 16. This flattened list becomes the input argument to `view.control.orient`.
...
def animate_trajectory(
    ...
    :param trajectory: the trajectory to animate
    :type trajectory: ase.io.Trajectory
    :param spacefill: If True, then atoms are visualized in spacefill stype
    :type spacefill: bool
    :param show_cell: True if the cell boundaries of the structure is to be shown
    :type show_cell: bool
    :param particle_size: Scaling factor for the spheres representing the atoms. (The radius is determined by
        the atomic number)
    :type particle_size: float
    :param center_of_mass: False (default) if the specified positions are w.r.t. the origin
    :type center_of_mass: bool
    :param camera: camera perspective, choose from "orthographic" or "perspective" (default is "orthographic")
    :type camera: str
    :return: nglview IPython widget
